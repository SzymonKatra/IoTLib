...
namespace iotlib
{
    ...
    namespace internal
    {
        ...
        {
        public:
            static int8_t deviceRead(BME280& bme280, uint8_t reg_addr, uint8_t *reg_data, uint16_t len);
            static int8_t deviceWrite(BME280& bme280, uint8_t reg_addr, uint8_t *reg_data, uint16_t len);
        };
    }
    ...
    private:
        int8_t deviceRead(uint8_t reg_addr, uint8_t *reg_data, uint16_t len);
        int8_t deviceWrite(uint8_t reg_addr, uint8_t *reg_data, uint16_t len);
    };
}